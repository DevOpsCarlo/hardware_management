...
//       inputDepartmentHead.value =
//         departmentHead === "Not assigned" ? "" : departmentHead;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  toggleEmployeeModal.addEventListener("click", () => {
    ...
    const deptCell = firstAssetRow.querySelector("td:nth-child(8)");
  ...
  //     .then(data => {
  //       employeeDeptSelect.innerHTML = '<option value="">-- Select Employee --</option>';
