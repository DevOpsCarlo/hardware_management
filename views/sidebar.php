<aside class="col-span-2 space-y-8 bg-slate-900 text-white dark:text-slate-400 shadow hidden md:block">
  <div class="flex flex-col justify-center items-center border-b-1 border-w-1/2 border-slate-100 py-11">
    <p class="text-slate-200 font-semibold text-xl text-center w-full">Hardware Inventory Management</p>
  </div>
